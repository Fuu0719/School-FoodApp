...
| 筆電最新驗證 | 2026-09-23：後端 44 通過／3 跳過，真實 MySQL 22 通過，Flutter 111 通過／2 跳過，analyze 無問題 |
...
2026-09-23 筆電驗證：Flutter 完整測試 111 通過／2 跳過，`flutter analyze` 無問題；後端測試 44 通過／3 真實 MySQL 跳過，另以筆電 MySQL 8.0 執行 22 項整合測試全數通過。測試包含電話驗證、商家自訂分類隔離、門市刪除、舊訂單保留及新下單拒絕。APK `1.0.0+5` 已建置，實機安裝與 ngrok HTTPS 驗收須以當次連線結果為準。
