...
2026-09-24 筆電驗證：Flutter 完整測試 113 通過／2 跳過，`flutter analyze` 無問題；後端測試 46 通過／3 真實 MySQL 跳過，另以筆電 MySQL 8.0 執行 24 項整合測試全數通過。APK `1.0.0+8` 已建置並安裝 Samsung 實機，內建 ngrok HTTPS 測試 API；會員首次資料、門市編輯、校園距離與商家商品表單已納入自動測試。
